        ...
        {todos.map((todo,index)=>(
         <div key={index} className="w-75 h-auto bg-dark text-center justify-content-center mx-auto p-4">
           {editindex===index ? (
            ...
            <button  className="col-auto bg-warning border border-2 rounded-pill border-primary hover:bg-dark cursor-pointer" onClick={() => handleupdate(index)}>Update</button>
            <button  className="col-auto bg-warning border border-2 rounded-pill border-primary hover:bg-dark cursor-pointer" onClick={() => setEditindex(null)}>cancel</button>
            </>
          ...
          <button className="col-auto bg-warning border border-2 rounded-pill border-primary hover:bg-dark cursor-pointer me-2" onClick={()=>handleEdit(index,todo.task)}>
              Edit
          </button>
